...
<body>
    ...
    ?>
    <h1>Etudiants</h1>
    <a href="etudiant.php" class="bouton">Ajouter un étudiant</a>
    <br><br>
    ...
    <table>
        ...
        <?php
            ...
            while($data=$requete->fetch()){
                ...
                echo '<td> <a href="etudiant.php?id='.$data['id'].'" class="bouton vert">Modifier</a>&nbsp;<a href="etudiant-supprimer.php?id='.$data['id'].'" class="bouton  rouge">Supprimer</a></td>'; //concaténation de la chaîne avec variable pour récupérer l'id de l'étudiant sélectionné
                echo '</tr>';
            }
        ?>
        <!-- <tr>
